...
export const inputVariants = cva(
  'flex rounded-md border font-normal border-input bg-transparent bg-secondary text-base md:text-sm ring-offset-background \
  file:border-0 file:text-foreground file:bg-transparent file:font-medium placeholder:text-muted-foreground \
